...
export default function PostJobForm({ company }) {
  ...
  // console.log(company, "company form");
...
console.log(JSON.stringify(company?.status), typeof company?.status);  // Consistent Tailwind design matching your dark style guide layout
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0e] text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-[#121214] border border-zinc-900 rounded-xl p-8 shadow-2xl">
        ...
        {company.status !== "Approved" && (
          <div className="bg-amber-950/30 border border-amber-900/50 text-amber-400 p-4 rounded-lg mb-6">
            <p className="text-sm">
              Your company profile is Pending approval. Please wait for approval
              before posting jobs.
            </p>
          </div>
        )}
